...
<div class="row-fluid">
	<div class="span8">
	@if (! $showCompleted)
		<h3 class="page-title">Incomplete <small>Tasks</small></h3>
	@else
		<h3 class="page-title">Completed <small>Tasks</small></h3>
	@endif
	</div>
	<div class="span4">
...
<div class="row-fluid">
	<div class="span12">
		<ul class="breadcrumb">
			...
			<li>{{ link_to('tasks/index/'.$project->id, $project->name) }}</li>
		</ul>
	</div>
</div>
